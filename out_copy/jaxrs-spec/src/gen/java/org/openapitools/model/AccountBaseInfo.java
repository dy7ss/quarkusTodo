...
public class AccountBaseInfo   {
  ...
  @JsonCreator
  public AccountBaseInfo(
    @JsonProperty(required = true, value = "accountCustomerName") String accountCustomerName
  ) {
  ...
  @JsonProperty(required = true, value = "accountCustomerName")
  @NotNull  @Pattern(regexp="^[A-Z][a-z]+$")public String getAccountCustomerName() {
  ...
  private static class AccountBaseInfoBuilderImpl extends AccountBaseInfoBuilder<AccountBaseInfo, AccountBaseInfoBuilderImpl> {
