...
public class Account   {
  ...
  public Account(
    ...
    @JsonProperty(required = true, value = "baseInfo") AccountBaseInfo baseInfo
  ) {
  ...
  @JsonProperty(required = true, value = "baseInfo")
  @NotNull @Valid public AccountBaseInfo getBaseInfo() {
    return baseInfo;
  }
  ...
  private static class AccountBuilderImpl extends AccountBuilder<Account, AccountBuilderImpl> {
